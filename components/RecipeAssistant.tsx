...
import { Loader2, ChefHat, ShoppingCart, Clock, Plus, Check, Filter } from 'lucide-react';
...
export const RecipeAssistant: React.FC<RecipeAssistantProps> = ({ addToCart, onGoToStore, onFly }) => {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto pb-20 p-4 max-w-2xl mx-auto w-full">
      ...
      {error && (
        <div className="bg-red-50 text-red-600 p-4 rounded-xl mb-6 border border-red-100 text-center">
          {error}
        </div>
      )}
